    ...
    <div className="App">
      <Container>
        <Header className="centralize mt-6">
          ...
          <p className="mt-6 mb-3">are you on OnlyFans page</p>
        </Header>
        <Content className="flex flex-row justify-evenly mt-[3rem]">
          <div className="w-[8.5rem]">
            <div className="w-full border-2 border-[#1a1919] hover:border-[#d8e91a86] bg-[#1a1919] rounded-lg h-[4.25rem] centralize cursor-pointer">
