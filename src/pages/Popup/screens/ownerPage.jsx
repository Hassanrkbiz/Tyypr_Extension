        ...
        <Content className="mt-[2rem]">
          ...
          <div>
            <div className='flex flex-row items-end justify-center'>
                <p className='text-[1.1rem] mr-4 ml-[6rem]'>unlimited pages</p>
                <p className='text-[1.1rem] text-[#d8e91a86] cursor-pointer'>add page</p>
            </div>
          </div>

          <div className='flex flex-row justify-center mt-4'>
            <p className='text-[1.3rem] ml-[11.5rem] mr-4'>$25</p>
